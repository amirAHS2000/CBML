...
def _get_prototype_cache_path(cfg):
    ...
    cache_dir = getattr(cfg.LOSSES.CBML_LOSS, "PROTOTYPE_CACHE_DIR", "resource/prototype_cache")
    ...
    key_dict = {
        ...
        "n_classes": cfg.LOSSES.CBML_LOSS.N_CLASSES,
        "proto_per_class": cfg.LOSSES.CBML_LOSS.PROTOTYPE_PER_CLASS,
        "init_method": cfg.LOSSES.CBML_LOSS.INIT_METHOD,
    ...
    fname = f"prototypes_{cfg.MODEL.BACKBONE.NAME}_{cfg.LOSSES.CBML_LOSS.INIT_METHOD}_{key_hash}.pt"
