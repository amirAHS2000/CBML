...
# mpcbml_loss
_C.LOSSES.MPCBML_LOSS = CN()
_C.LOSSES.MPCBML_LOSS.INIT_METHOD = 'kmeans'
_C.LOSSES.MPCBML_LOSS.N_CLASSES = 100
_C.LOSSES.MPCBML_LOSS.PROTOTYPE_PER_CLASS = 3
_C.LOSSES.MPCBML_LOSS.GAMMA_REG = 0.2
_C.LOSSES.MPCBML_LOSS.LAMBDA_REG = 2.0
_C.LOSSES.MPCBML_LOSS.THETA_IS_LEARNABLE = False
_C.LOSSES.MPCBML_LOSS.INIT_THETA = 1.0
...
_C.DATA.KNN = 1
_C.DATA.EVAL_TRAIN_SUBSAMPLE_SIZE = 1200
_C.DATA.EVAL_TRAIN_SUBSAMPLE_SEED = 0
...
_C.SOLVER.WEIGHT_LR = 0.00003
_C.SOLVER.WEIGHT_MOMENTUM = 0.0
_C.SOLVER.BACKBONE_LR_MULT = 0.2
_C.SOLVER.HEAD_LR_MULT = 1.0
